...
const autobackup = require('./kaguya/autobackup')
...
module.exports = {
    async handler(chatUpdate) {
        ...
        try {
            ...
            if (opts['gconly'] && !m.fromMe && !m.chat.endsWith('g.us')) return /*await conn.sendMessage(m.chat, { text: "*Maaf kak*\nakiraa Bot Tidak Bisa Digunakan digunakan di private chat\n\n_Hanya Bisa Digunakan Di Dalam Group_\n\nUpgrade Ke premium atau Join Grup Official Akiraa bot untuk mendapatkan akses di privat chat\n" + sgc,   contextInfo: { externalAdReply: { showAdAttribution: true, title: "Bot Only group\nyou are can't acces",  body: wm,   thumbnailUrl: "https://telegra.ph/file/6c7e67ae027b1305c965c.png", sourceUrl: sgc, mediaType: 1,   renderLargerThumbnail: true }}}, { quoted: m})*/
...
global.dfail = (type, m, conn) => {
    ...
    let Syaiithumb = 'https://telegra.ph/file/b5b49d3accd19b7ca504c.jpg'
    let Syaiithumb2 = 'https://telegra.ph/file/b5b49d3accd19b7ca504c.jpg'
...
let msg = {
 ...
 botAdmin: `*Bot Admin Mode:* Kaguya must be an admin to use this feature`,
 ...
 if (msg) return conn.sendMessage(m.chat,{text: msg, contextInfo: {
    ...
    forwardedNewsletterMessageInfo: {
      ...
      newsletterName: 'shinomiya Tech Bot WhatsApp',
      serverMessageId: -1
    },
    businessMessageForwardInfo: { businessOwnerJid: '6281224115259@s.whatsapp.net' },
    forwardingScore: 256,
    externalAdReply: {
      title: 'Kaguya Sama (ver ' + version + ' )',
      body: 'shinomiya Tech Bot WhatsApp',
      thumbnailUrl: 'https://telegra.ph/file/7d04ea0a581877638db95.jpg',
      sourceUrl: 'https://アキラ.site/',
      mediaType: 1,
      renderLargerThumbnail: true
    }
 ...
 let msgg = {
 unreg: "*Register required:* You cannot access before registering, Please register with me using the following method\n\n*[ REGISTRATION METHOD ]*\n.register kaguya.17"
 }[type]
 if (msgg) return conn.sendMessage(m.chat,{text: msgg,contextInfo: {
    mentionedJid: [],
    groupMentions: [],
    isForwarded: true,
    forwardedNewsletterMessageInfo: {
 ...
 if (msg2) return conn.sendMessage(m.chat,{text: msg2,contextInfo: {
    mentionedJid: [],
    groupMentions: [],
    isForwarded: true,
    forwardedNewsletterMessageInfo: {
